...
- whether the record came from a **subagent**
...
- the **working directory path** of the repo you're in

It does **not** collect your prompts, your code, or file *contents*.
That is a fixed scope for what this package's OTLP telemetry reports.

This package does not include transcript-based usage recovery (removed
2026-09-10 after a measured double-billing risk); that capability is available
