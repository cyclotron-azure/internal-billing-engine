---
name: feature
description: Orchestrate a feature for internal-billing-engine end-to-end — evaluator-gated goal, task, audit, docs, and PR phases, all execution delegated to fresh-context subagents. Invoke for any non-trivial feature.
---
...
Rules section — it is the single easiest way for a worker to break this codebase.
